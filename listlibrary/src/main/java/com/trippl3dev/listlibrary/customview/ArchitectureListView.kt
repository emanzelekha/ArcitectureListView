...
class ArchitectureListView : FrameLayout, ArchitectureList.ListReadyCallbak {
    ...
    private fun setAttrs(context: Context, attrs: AttributeSet?, defStyleAttr: Int) {
        ...
        fragmentId = a.getResourceId(R.styleable.ArchitectureListView_fragmentId,0)
        if (fragmentId == 0){
            fragmentTag = a.getString(R.styleable.ArchitectureListView_fragmentId)
        }
